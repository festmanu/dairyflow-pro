...
export function EditAnimalDialog({
  ...
  useEffect(() => {
    if (animal) {
      form.reset({
        ...
        name: animal.name,
        breed: animal.breed,
        dateOfBirth: parseISO(animal.dateOfBirth),
        gender: animal.gender,
        status: animal.status,
        sireId: animal.sireId || "none",
        damId: animal.damId || "none",
        notes: animal.notes || "",
      });
  ...
  const maleAnimals = animals.filter((a) => a.gender === "male" && a.id !== animal?.id);
  const femaleAnimals = animals.filter((a) => a.gender === "female" && a.id !== animal?.id);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Animal - {animal.name}</DialogTitle>
        </DialogHeader>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will permanently remove {animal.name} from your herd records.
